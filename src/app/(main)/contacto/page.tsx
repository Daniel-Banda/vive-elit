          ...
          <div className="md:w-1/3 bg-slate-900 p-12 text-white">
            ...
            <div className="space-y-12">
              <div>
                ...
                <p className="font-serif text-xl italic leading-relaxed">Rey Felipe #438<br />Residencial Colinas del Rey<br />CP 28979</p>
              </div>
              <div>
                <p className="text-slate-500 text-[9px] uppercase font-bold tracking-widest mb-2">Atención Directa</p>
                <p className="text-lg font-bold">312 122 2277</p>
                <p className="text-lg font-bold">312 298 9466</p>
              </div>
              <a
                href="https://wa.me/523121222277"
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-3 bg-green-500 text-white px-6 py-3 rounded-full text-xs font-bold uppercase tracking-widest hover:bg-green-600 transition-colors"
              >
                <span>WhatsApp</span>
